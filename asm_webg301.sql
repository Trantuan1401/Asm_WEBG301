...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th3 15, 2024 lúc 06:50 PM
...
('DoctrineMigrations\\Version20240315145106', '2024-03-15 15:51:47', 185);
...
--
ALTER TABLE `order`
  ADD CONSTRAINT `Order_Book` FOREIGN KEY (`book_id`) REFERENCES `book` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `Order_Customer` FOREIGN KEY (`customer_id`) REFERENCES `customer` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
